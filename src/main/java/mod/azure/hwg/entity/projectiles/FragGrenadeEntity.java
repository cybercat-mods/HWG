...
public class FragGrenadeEntity extends PersistentProjectileEntity implements IAnimatable {
	...
	public FragGrenadeEntity(World world, LivingEntity owner) {
		super(ProjectilesEntityRegister.FRAG_GRENADE, owner, world);
	}

	protected FragGrenadeEntity(EntityType<? extends FragGrenadeEntity> type, double x, double y, double z,
			World world) {
		this(type, world);
	}

	protected FragGrenadeEntity(EntityType<? extends FragGrenadeEntity> type, LivingEntity owner, World world) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<FragGrenadeEntity>(this, "controller", 0, this::predicate));
	}
