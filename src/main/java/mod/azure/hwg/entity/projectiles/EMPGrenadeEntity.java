...
public class EMPGrenadeEntity extends PersistentProjectileEntity implements IAnimatable {
	...
	public EMPGrenadeEntity(EntityType<? extends EMPGrenadeEntity> entityType, World world) {
		super(entityType, world);
		this.pickupType = PersistentProjectileEntity.PickupPermission.DISALLOWED;
	}

	public EMPGrenadeEntity(World world, LivingEntity owner) {
		super(ProjectilesEntityRegister.EMP_GRENADE, owner, world);
	}

	protected EMPGrenadeEntity(EntityType<? extends EMPGrenadeEntity> type, double x, double y, double z, World world) {
		this(type, world);
	}

	protected EMPGrenadeEntity(EntityType<? extends EMPGrenadeEntity> type, LivingEntity owner, World world) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<EMPGrenadeEntity>(this, "controller", 0, this::predicate));
	}
