...
public class MagentaFlareEntity extends PersistentProjectileEntity {

	public int life;

	public MagentaFlareEntity(World world, double x, double y, double z, ItemStack stack) {
		super(ProjectilesEntityRegister.MAGENTA_FLARE, world);
		this.updatePosition(x, y, z);
	}

	public MagentaFlareEntity(EntityType<? extends MagentaFlareEntity> entityType, World world) {
		super(entityType, world);
	}

	public MagentaFlareEntity(World world, @Nullable Entity entity, double x, double y, double z, ItemStack stack) {
		this(world, x, y, z, stack);
		this.setOwner(entity);
	}

	public MagentaFlareEntity(World world, ItemStack stack, LivingEntity shooter) {
		this(world, shooter, shooter.getX(), shooter.getY(), shooter.getZ(), stack);
	}

	public MagentaFlareEntity(World world, ItemStack stack, double x, double y, double z, boolean shotAtAngle) {
		this(world, x, y, z, stack);
	}

	public MagentaFlareEntity(World world, ItemStack stack, Entity entity, double x, double y, double z,
			boolean shotAtAngle) {
	...
	public void tick() {
		...
		if (this.world.isClient) {
			this.world.addParticle(HWGParticles.MAGENTA_FLARE, true, this.getX(), this.getY() - 0.3D, this.getZ(),
	...
	protected ItemStack asItemStack() {
		return new ItemStack(HWGItems.MAGENTA_FLARE);
	}
