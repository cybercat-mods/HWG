...
public class LightblueFlareEntity extends PersistentProjectileEntity {

	public int life;

	public LightblueFlareEntity(World world, double x, double y, double z, ItemStack stack) {
		super(ProjectilesEntityRegister.LIGHTBLUE_FLARE, world);
		this.updatePosition(x, y, z);
	}

	public LightblueFlareEntity(EntityType<? extends LightblueFlareEntity> entityType, World world) {
		super(entityType, world);
	}

	public LightblueFlareEntity(World world, @Nullable Entity entity, double x, double y, double z, ItemStack stack) {
		this(world, x, y, z, stack);
		this.setOwner(entity);
	}

	public LightblueFlareEntity(World world, ItemStack stack, LivingEntity shooter) {
		this(world, shooter, shooter.getX(), shooter.getY(), shooter.getZ(), stack);
	}

	public LightblueFlareEntity(World world, ItemStack stack, double x, double y, double z, boolean shotAtAngle) {
		this(world, x, y, z, stack);
	}

	public LightblueFlareEntity(World world, ItemStack stack, Entity entity, double x, double y, double z,
			boolean shotAtAngle) {
	...
	protected ItemStack asItemStack() {
		return new ItemStack(HWGItems.LIGHTBLUE_FLARE);
	}
