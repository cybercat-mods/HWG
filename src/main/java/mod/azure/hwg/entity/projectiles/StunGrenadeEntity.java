...
public class StunGrenadeEntity extends PersistentProjectileEntity implements IAnimatable {
	...
	public StunGrenadeEntity(EntityType<? extends StunGrenadeEntity> entityType, World world) {
		super(entityType, world);
		this.pickupType = PersistentProjectileEntity.PickupPermission.DISALLOWED;
	}

	public StunGrenadeEntity(World world, LivingEntity owner) {
		super(ProjectilesEntityRegister.STUN_GRENADE, owner, world);
	}

	protected StunGrenadeEntity(EntityType<? extends StunGrenadeEntity> type, double x, double y, double z,
			World world) {
		this(type, world);
	}

	protected StunGrenadeEntity(EntityType<? extends StunGrenadeEntity> type, LivingEntity owner, World world) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<StunGrenadeEntity>(this, "controller", 0, this::predicate));
	}
