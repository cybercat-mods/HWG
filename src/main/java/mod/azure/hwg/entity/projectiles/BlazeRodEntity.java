...
public class BlazeRodEntity extends AbstractArrow implements GeoEntity {
	...
	protected void explode() {
		this.level().explode(this, this.getX(), this.getY(0.0625D), this.getZ(), 1.0F, false, HWGMod.config.gunconfigs.balrog_breaks == true ? Level.ExplosionInteraction.BLOCK : Level.ExplosionInteraction.NONE);
	}
