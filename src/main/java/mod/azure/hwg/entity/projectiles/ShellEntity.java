...
public class ShellEntity extends PersistentProjectileEntity implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ShellEntity>(this, "controller", 0, this::predicate));
	}
	...
	protected void onEntityHit(EntityHitResult entityHitResult) {
		...
		if (entity.damage(damageSource2, 5F)) {
