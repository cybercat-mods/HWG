...
public class HWGMod implements ModInitializer {
    ...
    public static final RecipeSerializer<GunTableRecipe> GUN_TABLE_RECIPE_SERIALIZER = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, HWGMod.modResource(GunTableRecipe.Type.ID), GunTableRecipe.Serializer.INSTANCE);
