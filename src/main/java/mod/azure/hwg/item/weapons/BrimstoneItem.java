		...
		if (entityLiving instanceof Player) {
			...
			if (stack.getDamageValue() < (stack.getMaxDamage() - 6)) {
				...
				if (!worldIn.isClientSide) {
					...
					fireball.shootFromRotation(playerentity, playerentity.getXRot(), playerentity.getYRot(), 0.0F,
							0.25F * 3.0F, 1.0F);
					...
					fireball1.shootFromRotation(playerentity, playerentity.getXRot(), playerentity.getYRot() + 5, 0.0F,
							0.25F * 3.0F, 1.0F);
					...
					fireball2.shootFromRotation(playerentity, playerentity.getXRot(), playerentity.getYRot() - 5, 0.0F,
							0.25F * 3.0F, 1.0F);
					...
					worldIn.playSound((Player) null, playerentity.getX(), playerentity.getY(), playerentity.getZ(),
							SoundEvents.FIREWORK_ROCKET_BLAST_FAR, SoundSource.PLAYERS, 1.0F,
