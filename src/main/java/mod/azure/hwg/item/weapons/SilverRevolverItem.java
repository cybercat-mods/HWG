...
public class SilverRevolverItem extends AnimatedItem {
            ...
            if (stack.getDamageValue() < (stack.getMaxDamage() - 1)) {
                ...
                if (!worldIn.isClientSide) {
                    ...
                    if (result != null) {
                        ...
                        bullet.tickCount = -15;
                        if (entityLiving.getRandom().nextInt(1, 101) <= 20 || EnchantmentHelper.getItemEnchantmentLevel(mod.azure.azurelib.platform.Services.PLATFORM.getIncendairyenchament(), stack) > 0)
    ...
    public void inventoryTick(ItemStack stack, Level world, Entity entity, int slot, boolean selected) {
        if (world.isClientSide && entity instanceof Player player && player.getMainHandItem().getItem() instanceof SilverRevolverItem) {
