...
public class BalrogItem extends HWGGunBase {
    ...
    public BalrogItem() {
        super(new Item.Properties().stacksTo(1).durability(HWGMod.config.gunconfigs.balrogconfigs.balrog_cap + 1));
    }
    ...
    public void releaseUsing(ItemStack stack, Level worldIn, LivingEntity entityLiving, int remainingUseTicks) {
        if (entityLiving instanceof Player playerentity && stack.getDamageValue() < (stack.getMaxDamage() - 4) && !playerentity.getCooldowns().isOnCooldown(this)) {
            ...
            if (!worldIn.isClientSide) {
                ...
                rod1.shootFromRotation(playerentity, playerentity.getXRot() + 2, playerentity.getYRot(), 0.0F, 3.0F, 1.0F);
                ...
                rod2.shootFromRotation(playerentity, playerentity.getXRot(), playerentity.getYRot() + 2, 0.0F, 3.0F, 1.0F);
                ...
                rod3.shootFromRotation(playerentity, playerentity.getXRot(), playerentity.getYRot() - 2, 0.0F, 3.0F, 1.0F);
    ...
    public void inventoryTick(ItemStack stack, Level world, Entity entity, int slot, boolean selected) {
        if (world.isClientSide && entity instanceof Player player && player.getMainHandItem().getItem() instanceof BalrogItem)
