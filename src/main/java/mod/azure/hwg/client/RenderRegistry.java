...
public class RenderRegistry {
	...
	public static void init() {
		...
		EntityRendererRegistry.register(ProjectilesEntityRegister.BLACK_FLARE, (ctx) -> new BlackFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.BLUE_FLARE, (ctx) -> new BlueFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.BROWN_FLARE, (ctx) -> new BrownFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.CYAN_FLARE, (ctx) -> new CyanFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.GRAY_FLARE, (ctx) -> new GrayFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.GREEN_FLARE, (ctx) -> new GreenFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.LIGHTBLUE_FLARE,
				(ctx) -> new LightblueFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.LIGHTGRAY_FLARE, (ctx) -> new LightgrayRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.LIME_FLARE, (ctx) -> new LimeFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.MAGENTA_FLARE, (ctx) -> new MagentaRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.ORANGE_FLARE, (ctx) -> new OrangeFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.PINK_FLARE, (ctx) -> new PinkFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.PURPLE_FLARE, (ctx) -> new PurpleFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.RED_FLARE, (ctx) -> new RedFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.WHITE_FLARE, (ctx) -> new WhiteFlareRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.YELLOW_FLARE, (ctx) -> new YellowFlareRender(ctx));
		...
		EntityRendererRegistry.register(ProjectilesEntityRegister.SMOKE_GRENADE, (ctx) -> new GSmokeRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.STUN_GRENADE, (ctx) -> new GStunRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.NAPALM_GRENADE, (ctx) -> new GNapalmRender(ctx));
		...
		EntityRendererRegistry.register(ProjectilesEntityRegister.SMOKE_GRENADE_S, (ctx) -> new GSmokeSRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.STUN_GRENADE_S, (ctx) -> new GStunSRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.NAPALM_GRENADE_S, (ctx) -> new GNapalmSRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.EMP_GRENADE_S, (ctx) -> new GEMPSRender(ctx));

		EntityRendererRegistry.register(ProjectilesEntityRegister.FRAG_GRENADE_S, (ctx) -> new GFragSRender(ctx));
