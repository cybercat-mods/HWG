...
public class FlameFiringRender extends GeoEntityRenderer<FlameFiring> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlameFiring animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
