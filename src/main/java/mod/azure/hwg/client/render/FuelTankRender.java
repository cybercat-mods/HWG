...
public class FuelTankRender extends EntityRenderer<FuelTankEntity> {
    ...
    protected static final ResourceLocation TEXTURE = HWGMod.modResource("textures/blocks/barrel_explode.png");
    ...
    public void render(FuelTankEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
