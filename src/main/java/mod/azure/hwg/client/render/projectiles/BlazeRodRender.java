...
public class BlazeRodRender extends GeoEntityRenderer<BlazeRodEntity> {
	...
	public BlazeRodRender(EntityRendererProvider.Context renderManagerIn) {
	...
	@Override
	public void preRender(PoseStack poseStack, BlazeRodEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
