...
public class ShellRender extends GeoEntityRenderer<ShellEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, ShellEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
