...
public class MBulletRender extends GeoEntityRenderer<MBulletEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, MBulletEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
