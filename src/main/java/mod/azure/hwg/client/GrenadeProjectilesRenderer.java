...
public class GrenadeProjectilesRenderer<T extends Entity & IAnimatable> extends EntityRenderer<T>
	...
	protected GrenadeProjectilesRenderer(EntityRenderDispatcher renderManager, AnimatedGeoModel<T> modelProvider) {
		super(renderManager);
