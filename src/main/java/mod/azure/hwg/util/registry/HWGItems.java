...
public class HWGItems {
	...
	public static AssasultItem SMG = item(new AssasultItem(3.0, 51, 3, "tommyfiring"), "smg");
	...
	public static AssasultItem TOMMYGUN = item(new AssasultItem(2.5, 51, 2, "tommyfiring"), "tommy_gun");
