...
public record HWGItems() {
    ...
    public static AssasultItem AK47 = item(new AssasultItem("akfiring"), "ak47");
    public static Assasult1Item SMG = item(new Assasult1Item("smgfiring"), "smg");
    ...
    public static Assasult2Item TOMMYGUN = item(new Assasult2Item("tommyfiring"), "tommy_gun");
