...
public class FlareRecipe extends SpecialCraftingRecipe {
	...
	public FlareRecipe(Identifier identifier) {
		super(identifier);
	}
	...
	public ItemStack craft(CraftingInventory craftingInventory) {
		ItemStack itemStack = new ItemStack(HWGItems.FLARE, 3);
	...
	public ItemStack getOutput() {
		return new ItemStack(HWGItems.FLARE);
	}

	public RecipeSerializer<?> getSerializer() {
		return HWGMod.FLARE_RECIPE_SERIALIZER;
	}
}
