...
public class HWGConfig extends CustomMidnightConfig {
	...
	public static List<String> merc_biomes = Arrays.asList("minecraft:forest", "minecraft:flower_forest",
			"minecraft:birch_forest", "minecraft:old_growth_birch_forest", "minecraft:dark_forest", "minecraft:grove",
			"minecraft:plains", "minecraft:snowy_plains", "minecraft:taiga", "minecraft:snowy_taiga",
			"minecraft:old_growth_pine_taiga", "minecraft:old_growth_spruce_taiga", "minecraft:bamboo_jungle",
			"minecraft:jungle", "minecraft:sparse_jungle", "minecraft:desert", "minecraft:desert_hills",
	...
	@Entry
	public static List<String> spy_biomes = Arrays.asList("minecraft:forest", "minecraft:flower_forest",
			"minecraft:birch_forest", "minecraft:old_growth_birch_forest", "minecraft:dark_forest", "minecraft:grove",
			"minecraft:plains", "minecraft:snowy_plains", "minecraft:taiga", "minecraft:snowy_taiga",
			"minecraft:old_growth_pine_taiga", "minecraft:old_growth_spruce_taiga", "minecraft:bamboo_jungle",
			"minecraft:jungle", "minecraft:sparse_jungle", "minecraft:desert", "minecraft:desert_hills",
	...
	@Entry
	public static List<String> lesser_biomes = Arrays.asList("minecraft:nether_wastes", "minecraft:soul_sand_valley",
	...
	@Entry
	public static List<String> greater_biomes = Arrays.asList("minecraft:nether_wastes", "minecraft:soul_sand_valley",
			"minecraft:crimson_forest", "minecraft:warped_forest", "minecraft:basalt_deltas");
	@Entry
