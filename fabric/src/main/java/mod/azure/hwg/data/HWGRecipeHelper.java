...
public interface HWGRecipeHelper {
	static void makeColoredFlares(RecipeOutput exporter) {
		makeGunTableRecipe(exporter, HWGItems.BLACK_FLARE.get(), 2, List.of(
		...
		makeGunTableRecipe(exporter, HWGItems.BLUE_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.BROWN_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.CYAN_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.GRAY_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.GREEN_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.LIGHTBLUE_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.LIGHTGRAY_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.LIME_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.MAGENTA_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.ORANGE_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.PINK_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.PURPLE_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.RED_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.WHITE_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
		...
		makeGunTableRecipe(exporter, HWGItems.YELLOW_FLARE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 3),
				Pair.of(Ingredient.of(Items.FIREWORK_ROCKET), 1),
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
	...
	static void makeGrenades(RecipeOutput exporter) {
		makeGunTableRecipe(exporter, HWGItems.G_EMP.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 5),
				Pair.of(Ingredient.of(Items.REDSTONE), 1)
		));

		makeGunTableRecipe(exporter, HWGItems.G_FRAG.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.TNT), 1),
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 5),
				Pair.of(Ingredient.of(Items.STICK), 1)
		));

		makeGunTableRecipe(exporter, HWGItems.G_NAPALM.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.TNT), 1),
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 5),
		...
		makeGunTableRecipe(exporter, HWGItems.G_SMOKE.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 5),
				Pair.of(Ingredient.of(Items.BLACK_DYE), 1),
				Pair.of(Ingredient.of(Items.STICK), 1)
		...
		makeGunTableRecipe(exporter, HWGItems.G_STUN.get(), 2, List.of(
				Pair.of(Ingredient.of(Items.GUNPOWDER), 2),
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 5),
	...
	static void makeWeapons(RecipeOutput exporter) {
		makeGunTableRecipe(exporter, HWGItems.AK47.get(), List.of(
		...
		makeGunTableRecipe(exporter, HWGItems.FLARE_GUN.get(), List.of(
		...
		makeGunTableRecipe(exporter, HWGItems.LUGER.get(), List.of(
				Pair.of(Ingredient.of(Items.IRON_NUGGET), 54),
				Pair.of(Ingredient.of(Items.LEVER), 1),
				Pair.of(Ingredient.of(Items.BLACK_TERRACOTTA), 2)
		));

		makeGunTableRecipe(exporter, HWGItems.PISTOL.get(), List.of(
				Pair.of(Ingredient.of(Items.IRON_INGOT), 5),
				Pair.of(Ingredient.of(Items.LEVER), 1),
				Pair.of(Ingredient.of(Items.BLACK_TERRACOTTA), 2)
		));

		makeGunTableRecipe(exporter, HWGItems.SHOTGUN.get(), List.of(
		...
		makeGunTableRecipe(exporter, HWGItems.SMG.get(), List.of(
		...
		makeGunTableRecipe(exporter, HWGItems.SPISTOL.get(), List.of(
				Pair.of(Ingredient.of(HWGItems.PISTOL.get()), 1),
				Pair.of(Ingredient.of(Items.IRON_INGOT), 2)
		));

		HWGRecipeHelper.makeGunTableRecipe(exporter, HWGItems.TOMMYGUN.get(), List.of(
