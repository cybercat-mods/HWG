...
public class HWGCategory implements DisplayCategory<HWGDisplay> {
    ...
    public List<Widget> setupDisplay(HWGDisplay display, Rectangle bounds) {
        ...
        if (display.count.get(0).intValue() > 0) {
            ...
            widgets.add(
                Widgets.createSlot(new Point(startPoint.x - 3, startPoint.y - 14))
                    .entries(display.input.get(0))
                    .disableBackground()
            );
            widgets.add(
                Widgets.createLabel(
                    new Point(
                        display.count.get(0).intValue() < 10 ? startPoint.x + 17 : startPoint.x + 13,
                        startPoint.y + 1
                    ),
                    Component.translatable(display.count.get(0).toString())
        ...
        if (display.count.get(1).intValue() > 0) {
            ...
            widgets.add(
                Widgets.createSlot(new Point(startPoint.x + 27, startPoint.y - 14))
                    .entries(display.input.get(1))
                    .disableBackground()
                    .unmarkInputOrOutput()
            );
            widgets.add(
                Widgets.createLabel(
                    new Point(
                        display.count.get(1).intValue() < 10 ? startPoint.x + 46 : startPoint.x + 43,
                        startPoint.y + 1
                    ),
        ...
        if (display.count.get(2).intValue() > 0) {
            ...
            widgets.add(
                Widgets.createSlot(new Point(startPoint.x + 57, startPoint.y - 14))
                    .entries(display.input.get(2))
                    .disableBackground()
            );
            widgets.add(
                Widgets.createLabel(
                    new Point(
                        display.count.get(2).intValue() < 10 ? startPoint.x + 76 : startPoint.x + 73,
                        startPoint.y + 1
                    ),
        ...
        if (display.count.get(3).intValue() > 0) {
            ...
            widgets.add(
                Widgets.createSlot(new Point(startPoint.x - 3, startPoint.y + 16))
                    .entries(display.input.get(3))
                    .disableBackground()
            );
            widgets.add(
                Widgets.createLabel(
                    new Point(
                        display.count.get(3).intValue() < 10 ? startPoint.x + 16 : startPoint.x + 14,
                        startPoint.y + 31
                    ),
        ...
        if (display.count.get(4).intValue() > 0) {
            ...
            widgets.add(
                Widgets.createSlot(new Point(startPoint.x + 27, startPoint.y + 16))
                    .entries(display.input.get(4))
                    .disableBackground()
            );
            widgets.add(
                Widgets.createLabel(
                    new Point(
                        display.count.get(4).intValue() < 10 ? startPoint.x + 46 : startPoint.x + 43,
                        startPoint.y + 31
                    ),
        ...
        widgets.add(
            Widgets.createSlot(outputPoint).entries(display.getOutputEntries().get(0)).disableBackground().markOutput()
        );
        return widgets;
    }
}
