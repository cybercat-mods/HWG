...
public class GrenadeModel extends GeoModel<GrenadeEntity> {
    ...
    public ResourceLocation getTextureResource(GrenadeEntity animatable) {
        return CommonMod.modResource("textures/item/projectiles/grenade_" + (animatable.getVariant() == 2 ? "frag" : animatable.getVariant() == 3 ? "napalm" : animatable.getVariant() == 4 ? "smoke" : animatable.getVariant() == 5 ? "stun" : "emp") + ".png");
    }
