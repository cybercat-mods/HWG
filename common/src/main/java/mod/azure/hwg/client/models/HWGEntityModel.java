...
public class HWGEntityModel<T extends HWGEntity & GeoEntity> extends GeoModel<T> {
    ...
    public ResourceLocation getModelResource(T animatable) {
        ...
        return CommonMod.modResource("geo/entity/" + model + ".geo.json");
    }
    ...
    public ResourceLocation getTextureResource(T animatable) {
        ...
        return CommonMod.modResource("textures/entity/" + texture + ".png");
    }
    ...
    public ResourceLocation getAnimationResource(T animatable) {
        ...
        return CommonMod.modResource("animations/entity/" + animation + ".animation.json");
    }
