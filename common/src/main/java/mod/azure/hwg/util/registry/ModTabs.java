        ...
        () -> Services.COMMON_REGISTRY.newCreativeTabBuilder()
            ...
            .displayItems((enabledFeatures, entries) -> {
                ...
                if (Services.COMMON_REGISTRY.isModLoaded("bewitchment"))
                    entries.accept(HWGItems.SILVERGUN.get());
                ...
                if (Services.COMMON_REGISTRY.isModLoaded("bewitchment"))
                    entries.accept(HWGItems.SILVERHELLHORSE.get());
                ...
                if (Services.COMMON_REGISTRY.isModLoaded("gigeresque"))
                    entries.accept(HWGItems.INCINERATOR.get());
                 ...
                 */
                if (Services.COMMON_REGISTRY.isModLoaded("bewitchment"))
                    entries.accept(HWGItems.SILVERBULLET.get());
