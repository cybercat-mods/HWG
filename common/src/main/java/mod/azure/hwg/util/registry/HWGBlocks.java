...
public record HWGBlocks() {
    ...
    public static final Supplier<Block> FUEL_TANK = CommonBlockRegistryInterface.registerBlock(
        CommonMod.MOD_ID,
        "fuel_tank",
        () -> new FuelTankBlock(
    ...
    public static final Supplier<Block> GUN_TABLE = CommonBlockRegistryInterface.registerBlock(
        CommonMod.MOD_ID,
        "gun_table",
        () -> new GunTableBlock(
