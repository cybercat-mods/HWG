...
public class RangedShootingAttack<E extends HWGEntity> extends CustomDelayedBehaviour<E> {
    ...
    protected ToIntFunction<E> attackIntervalSupplier = entity -> (entity.getItemBySlot(EquipmentSlot.MAINHAND).is(HWGItems.AK47.get()) || entity.getItemBySlot(EquipmentSlot.MAINHAND).is(HWGItems.SMG.get()) || entity.getItemBySlot(EquipmentSlot.MAINHAND).is(HWGItems.TOMMYGUN.get())) ? 1 : entity.getItemBySlot(EquipmentSlot.MAINHAND).is(HWGItems.FLAMETHROWER.get())? 3 : 20;
