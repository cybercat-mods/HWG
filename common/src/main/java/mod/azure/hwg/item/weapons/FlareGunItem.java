...
public class FlareGunItem extends HWGGunLoadedBase {
    ...
    public static final Predicate<ItemStack> FLARE = BLACK_FLARE.or(stack -> stack.getItem() == HWGItems.BLUE_FLARE)
        .or(stack -> stack.getItem() == HWGItems.BROWN_FLARE)
        .or(stack -> stack.getItem() == HWGItems.CYAN_FLARE)
        .or(stack -> stack.getItem() == HWGItems.GRAY_FLARE)
        .or(stack -> stack.getItem() == HWGItems.GREEN_FLARE)
        .or(stack -> stack.getItem() == HWGItems.LIGHTBLUE_FLARE)
        .or(stack -> stack.getItem() == HWGItems.LIGHTGRAY_FLARE)
        .or(stack -> stack.getItem() == HWGItems.LIME_FLARE)
        .or(stack -> stack.getItem() == HWGItems.MAGENTA_FLARE)
        .or(stack -> stack.getItem() == HWGItems.ORANGE_FLARE)
        .or(stack -> stack.getItem() == HWGItems.PINK_FLARE)
        .or(stack -> stack.getItem() == HWGItems.PURPLE_FLARE)
        .or(stack -> stack.getItem() == HWGItems.RED_FLARE)
        .or(stack -> stack.getItem() == HWGItems.WHITE_FLARE)
    ...
    private void shootFlare(
        ...
        for (ItemStack itemStack : projectile) {
            if (!itemStack.isEmpty()) {
                ...
                var flareEntity = new BaseFlareEntity(
                    level,
                    shooter,
                    shooter.getX(),
                    shooter.getEyeY() - 0.15000000596046448D,
                    shooter.getZ(),
                    true
                );
                ...
                var quaternionf = new Quaternionf().setAngleAxis(
                    (float) 0.0 * ((float) Math.PI / 180),
                    vec3d.x,
                    vec3d.y,
                    vec3d.z
                );
    ...
    public static boolean isCharged(ItemStack stack) {
        ChargedProjectiles chargedProjectiles = stack.getOrDefault(
    ...
    public void appendHoverText(
        ...
        if (chargedProjectiles != null && !chargedProjectiles.isEmpty()) {
            ...
            tooltipComponents.add(
                Component.literal("Ammo").append(CommonComponents.SPACE).append(itemStack.getDisplayName())
            );
