...
public class HWGItems {
	...
	public static AssasultItem AK47 = item(new AssasultItem(2.5, 21, 5, "akfiring"), "ak47");
	public static Assasult1Item SMG = item(new Assasult1Item(3.0, 51, 3, "smgfiring"), "smg");
